...
class Admin_Menu {
	...
	public function enqueue_assets( $hook ) {
		...
		wp_localize_script( 'mri-siteoptimizer-admin', 'MRI SiteOptimizerData', [
			...
			$inline_js .= '$.post(MRI SiteOptimizerData.ajaxurl,{action:"mri_siteoptimizer_db_optimize",nonce:MRI SiteOptimizerData.nonce})';
